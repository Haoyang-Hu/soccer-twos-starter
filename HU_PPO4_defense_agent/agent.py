# HU_PPO4_defense_agent/agent.py
#
...
# Warm-start:  HU_PPO3 self-play checkpoint (PPO_selfplay/checkpoint-7500,
...
# ============================================================================
# Evaluation of HU_PPO3 vs CEIA showed 95 % win rate but avg 6.8 goals
...
# from HU_PPO3 unchanged so scoring ability is not degraded.
#
# ============================================================================
...
# pattern used in ceia_baseline_agent/agent_ray.py and all HU_PPO agents.
#
